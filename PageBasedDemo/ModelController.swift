...
class ModelController: NSObject, UIPageViewControllerDataSource {
    ...
    override init() {
        super.init()
        mainTitleData = ["Special Offers!","Business"]
        subTitleData  = ["The Easiest Way To Find Special Offers!","The Easiest Way To Made Your Business!"]
        imgNameData   = ["",""]
        btnTitleData   = ["PROCEED","NEXT"]
        indexData         = 0
    }
